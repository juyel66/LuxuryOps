      ...
      <div className="w-full container mx-auto">
        ...
        <nav className="flex items-center justify-between border border-white/15 bg-black px-4 py-2.5 lg:rounded-full lg:border-transparent lg:bg-[#111] lg:px-6 lg:py-3 transition-all duration-300 shadow-sm lg:shadow-none text-white">
          ...
          <Link href="/" className="flex items-center">
            <Image src={logoImage} alt="logo" width={140} height={40} className="w-[98px] sm:w-[120px] lg:w-20 lg:h-10" />
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <div className="flex items-center gap-4 text-white text-sm">
              <Image src={instagram} alt="Instagram" className="w-5 h-5 text-white" />
              <Link href="/user-dashboard/overview" className="opacity-70">
                DASHBOARD
              </Link>
            </div>
          </div>
          ...
          <div className="border border-white/15 bg-black p-4 shadow-md text-white">
            <ul className="flex flex-col gap-3">
              ...
              <Link
                href="/contact"
                onClick={() => setIsMenuOpen(false)}
                className="mt-2 inline-flex justify-center bg-white px-5 py-2.5 text-black font-medium"
              >
                Book a Demo
              </Link>
            </ul>
