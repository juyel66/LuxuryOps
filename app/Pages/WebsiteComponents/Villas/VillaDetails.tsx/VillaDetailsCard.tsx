...
export default function VillaDetailsCard() {
  return (
    <section className="py-20 text-white bg-[#0A0A0A] md:py-28">
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-col gap-6 mb-12 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            ...
            className="flex items-center px-6 py-3 text-yellow-500"
          >
            VIEW ALL VILLAS <Image src={rightArrowYellow} alt="star" className="w-4 h-4 ml-1" />
          </Link>
        </div>
