...
export default function PrivacyPolicyHomePage() {
  return (
        ...
        <div className="container flex items-center justify-between w-full mx-auto">
          ...
          <div className="container mx-auto">
            ...
            <h2 className="md:hidden text-[32px] sm:text-[42px] lg:text-[56px] leading-[1.2] font-cardo italic mb-6">
             Your privacy is important to us.  Please read our Privacy Policy to  learn more about how we collect and  use your personal information.
            </h2>
            
            <h2 className="md:flex hidden text-[32px] sm:text-[42px] lg:text-[56px] leading-[1.2] font-cardo italic mb-6">
             Your privacy is important to us. <br /> Please read our Privacy Policy to <br /> learn more about how we collect and <br /> use your personal information.
            </h2>
