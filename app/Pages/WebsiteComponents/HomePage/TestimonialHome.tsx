        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="p-6 border border-white/10 rounded-xl bg-white/5 backdrop-blur-md">
            <p className="text-[#CFCFCF] text-sm leading-[1.8] mb-6">
              At VVIP Luxury Chauffeur Services we felt as though we were back
              home in Monaco. Amani and his team are amazing. Definitely will be
              booking again and again.
            </p>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <span className="text-[#9CA3AF] text-xs">Monaco</span>
              </div>
          ...
          <div className="p-6 border border-white/10 rounded-xl bg-white/5 backdrop-blur-md">
            <p className="text-[#CFCFCF] text-sm leading-[1.8] mb-6">
              The level of professionalism and attention to detail exceeded all
              expectations. Our corporate team was impressed with the seamless
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <span className="text-[#9CA3AF] text-xs">London, UK</span>
              </div>
          ...
          <div className="p-6 border border-white/10 rounded-xl bg-white/5 backdrop-blur-md">
            <p className="text-[#CFCFCF] text-sm leading-[1.8] mb-6">
              Impeccable service from start to finish. The chauffeur was
              punctual, professional, and the vehicle was absolutely pristine.
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <span className="text-[#9CA3AF] text-xs">Singapore</span>
              </div>
