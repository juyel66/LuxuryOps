        ...
        <div className="grid items-start grid-cols-1 gap-12 md:gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:auto-rows-fr md:gap-8">
            ...
            {services.map((item, index) => (
              ...
              >
                {/* BACK CARD */}
                <div className="absolute top-3 right-3 w-full h-full rounded-2xl bg-[#121212] border border-[#D4AF37]/20 opacity-70" />

                {/* MAIN CARD */}
                <div className="relative flex flex-col h-full p-5 border rounded-2xl md:p-6 backdrop-blur-xl bg-[#121212] border-white/10">
