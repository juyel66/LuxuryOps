    ...
    <section className="px-6 py-20 text-white bg-black sm:px-10 lg:px-20">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10">
        ...
        <div>
          ...
          {/* DESCRIPTION */}
          <p className="text-[#9CA3AF] text-sm leading-[1.9] max-w-[700px]">
            The Range Rover Vogue is more than just a luxury SUV; it’s a statement of refined taste and extraordinary capability...
          </p>
        ...
        <div className="border border-white/10 rounded-xl p-6 bg-[#0B0B0B] h-fit">
          ...
          <p className="mb-4 text-sm cursor-pointer text-white/60">
            Show More
          </p>
          ...
          <Link
            href="#"
            className="block text-center bg-[#D4AF37] text-black py-3 text-sm uppercase tracking-wider hover:opacity-90"
          >
            Book This Vehicle →
          </Link>
        </div>
